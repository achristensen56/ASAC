%% preprocessing
function [] = pp_movie_v2(directory)
    cd(directory);
    movie_file = ls('*.isxd');
    ...
    config.preprocess = true;  % Assuming the movie is already preprocessed
    ...
    [M2, config] = preprocess_movie(M,config);
    save_movie_to_hdf5(M2,'m_dff.hdf5');
    clear all;
% 
%     %view_movie(M);
% 
