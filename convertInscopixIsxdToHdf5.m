function [success] = convertInscopixIsxdToHdf5(inputFilePath,varargin)
	...
	try
		...
		try
			...
			pathToISX = 'C:\Program Files\Inscopix\Data Processing';%uigetdir('\.','Enter path to Inscopix Data Processing program installation folder (e.g. +isx should be in the directory)');
			addpath(pathToISX);
			help isx
		end
